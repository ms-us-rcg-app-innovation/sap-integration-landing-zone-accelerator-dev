...
var functionAppName = 'functionapp-scenario2a1-${workloadName}-${deploymentEnvironment}'
var appServiceName = 'appservice-scenario2a1-${workloadName}-${deploymentEnvironment}'
